...
@NamedQueries({
		...
		@NamedQuery(name = Personajuridica.f_searched, query = "SELECT p FROM Personajuridica p INNER JOIN p.representanteLegal rl WHERE p.numerodocumento LIKE :searched OR UPPER(p.razonsocial) LIKE :searched") })
