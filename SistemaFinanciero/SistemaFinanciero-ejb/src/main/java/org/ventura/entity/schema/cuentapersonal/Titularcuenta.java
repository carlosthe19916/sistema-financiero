...
@NamedQueries({
		...
		@NamedQuery(name = Titularcuenta.FindAllForCuentacorriente, query = "SELECT t FROM Titularcuenta t INNER JOIN t.cuentacorriente c WHERE c.idcuentacorriente =:idcuentacorriente"),
