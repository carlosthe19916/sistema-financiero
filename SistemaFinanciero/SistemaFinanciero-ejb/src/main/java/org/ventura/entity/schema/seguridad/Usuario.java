...
@NamedQueries({
		...
		@NamedQuery(name = Usuario.f_idagencia, query = "SELECT DISTINCT u FROM Usuario u INNER JOIN u.trabajador t INNER JOIN t.agencia a LEFT JOIN u.grupos g LEFT JOIN g.rols r WHERE a.idagencia= :idagencia AND u.estado = TRUE ORDER BY u.username"),
